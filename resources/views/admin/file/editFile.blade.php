  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        -------------------------->
          ...
          <div class="form">
                          ...
                          {{ csrf_field() }}
  							...
  							<div class="col-md-6">
  								<input id="fileTitle" type="text" class="form-control" name="fileTitle" value="{{$file->title}}" required style="margin-bottom:15px;">
                  </div>
                  </div>
                  <div class="form-group">
        ...
        <a class="btn btn-default" href={{ asset('storage/myAssets/files/'.$file->filename) }} download= {{$file->title}} >Download Currently Uploaded File</a>
</div>
