@extends('layouts.siteView') {{-- |---------------------------------- Head ----------------------------------| --}} @section('head')
@endsection {{-- |---------------------------------- Body ----------------------------------| --}} @section('body') {{--
|---------------------------------- PageTitle Div ----------------------------------| --}}
...
<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 col-lg-offset-1 col-md-offset-1 well">
  @for ($i=0; $i<count($visitorPrevMessage) ; $i++) <div id="messageSet" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
