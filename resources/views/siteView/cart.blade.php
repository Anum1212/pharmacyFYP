	...
	<table id="cart" class="table table-hover table-condensed">
            ...
            @foreach(Cart::content() as $row)
						<tr>
							...
							<td data-th="Seller">
										<h4 class="nomargin"><a href="{{'/pharmacyDetails/'.$row->options->pharmacistId}}">{{$row->options->pharmacistName}}</h4>
								</div>
							</td>
            ...
            <tr>
              ...
              <td> <button type="submit" class="btn btn-info btn-block"><i class="fa fa-refresh"></i> UpdateCart</button></td>
							<td><a href="{{'/CheckOutCart'}}" class="btn btn-success btn-block">Checkout <i class="fa fa-angle-right"></i></a></td>
    ...
    <th style="width:10%">Remove</th>
      ...
      <tbody>
        ...
        <tr style="height:50px;">
          <td data-th="Remove"><form action="{{'/removeFromCart/'.$row->rowId}}" method="post">
