      ...
      <div class="container containerDashboardContent">
        <form action="/pharmacist/editProduct/{{$product->id}}" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="productName" placeholder="Enter productName" name="productName" value="{{$product->name}}"
              required>
          </div>
          <div class="form-group">
            <label for="dosage">Dosage(mg/ml):</label>
            <input type="number" class="form-control" id="dosage" placeholder="Enter dosage" name="dosage" value="{{$product->dosage}}"
              required>
          </div>
