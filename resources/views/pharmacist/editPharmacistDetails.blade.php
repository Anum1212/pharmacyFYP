      ...
      <section class="content container-fluid">
        ...
        <form class="form-horizontal" role="form" method="POST" action="/pharmacist/editAccountDetails">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="contact" type="text" class="form-control" name="contact" minlength="11" maxlength="11" value="{{ $pharmacyDetails->contact }}" required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="pharmacyName" type="text" class="form-control" name="pharmacyName" value="{{ $pharmacyDetails->pharmacyName }}" required autofocus>
                        </div>
                        </div>
