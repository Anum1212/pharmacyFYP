@extends('layouts.authPharmacist') @section('tabTitle', 'Reset Password') @section('body')
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="fullPage panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ route('pharmacist.password.request') }}">
                    {{ csrf_field() }}
