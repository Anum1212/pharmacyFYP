    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Pharmacist Register</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('pharmacist.register.store') }}">
                        ...
                        <div class="form-group{{ $errors->has('contact') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="contact" type="text" class="form-control" name="contact" minlength="11" maxlength="11" value="{{ old('contact') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('pharmacyName') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="pharmacyName" type="text" class="form-control" name="pharmacyName" value="{{ old('pharmacyName') }}" required autofocus>
