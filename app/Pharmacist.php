...
class Pharmacist extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'status', 'name', 'email', 'contact', 'pharmacyName', 'address', 'society', 'city', 'latitude', 'longitude', 'freeDeliveryPurchase', 'dataSource', 'dbAPI', 'password', 'verificationToken', 'verificationStatus',
    ];
